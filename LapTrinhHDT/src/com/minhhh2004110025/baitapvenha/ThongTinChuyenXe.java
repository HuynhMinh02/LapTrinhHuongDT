...
public class ThongTinChuyenXe {
    ...
    public ThongTinChuyenXe(String maSoChuyen, String hoTenTaiXe, String soXe, double doanhThu) {
        super();
    ...
    public String toString() {
        return "Mã số chuyến: " + this.maSoChuyen + ", họ tên tài xế: " + this.hoTenTaiXe + ", số xe: " + this.soXe + ", doanh thu: " + this.doanhThu;
    }
}
